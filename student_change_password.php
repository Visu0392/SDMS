...
$username=$_SESSION['alogin'];
    $sql ="SELECT Password FROM student WHERE UserName=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update student set Password=:newpassword where UserName=:username";
...
<?php include('includes/student_leftbar.php');?>                   
 <!-- /.left-sidebar -->
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							<li><a href="student_dashboard.php"><i class="fa fa-home"></i> Home</a></li>
