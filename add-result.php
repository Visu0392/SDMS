...
//     $mar=$marks[$i];
//   $sid=$sid1[$i];
$sql="INSERT INTO  tblresult(StudentId,ClassId,SubjectId,marks) VALUES(:studentid,:class,:subject,:marks)";
$query = $dbh->prepare($sql);
$query->bindParam(':studentid',$studentid,PDO::PARAM_STR);
$query->bindParam(':class',$class,PDO::PARAM_STR);
$query->bindParam(':subject',$sid,PDO::PARAM_STR);
...
<div class="form-group">
                                                        <label for="date" class="col-sm-2 control-label">Subject</label>
                                                        <div class="col-sm-10">
                                                        <select name="subject" class="form-control clid" id="subjectid" onChange="getStudent(this.value);" required="required">
...
<div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                        <input name="studentid" class="form-control clid" id="classid" required="required"></input>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                        <input name="marks" class="form-control clid" id="marksid" required="required"></input>
