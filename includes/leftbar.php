...
<li class="has-children">
                                        ...
                                        <a href="#"><i class="fa fa-info-circle"></i> <span>Question Paper Generator</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="qp_generator.php"><i class="fa fa-bars"></i> <span>Question Entry</span></a></li>
                                            <li><a href="generate_qp.php"><i class="fa fa-bars"></i> <span>Paper Generation</span></a></li>
                                        </ul>
                                        <!-- <li><a href="qp_generator.php"><i class="fa fa-question-circle"></i> <span>Question Paper Generator</span></a></li> -->
