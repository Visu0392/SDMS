...
$sql="INSERT INTO questionpaper(subject, class, question) VALUES(:subject,:class,:question)";
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Questions Entry</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Questions Entry</li>
                                    </ul>
                                </div>
...
<?php }} ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
<textarea name="question" class="form-control" id="default" required="required"></textarea>
                                                        </div>
                                                    </div>
